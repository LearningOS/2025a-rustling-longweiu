...
unsafe fn modify_by_address(address: usize) {
    ...
    // and that there are no other references (shared or mutable) to the same memory location
    // at the time of this call. This ensures compliance with Rust's aliasing rules.
    unsafe {
